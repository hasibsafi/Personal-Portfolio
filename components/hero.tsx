      ...
      >
        ...
        <div
          className={`flex flex-col gap-6 ${
            splitPhase ? "md:flex-row md:items-center md:gap-10" : ""
          }`}
        >
          ...
          >
            <div className="overflow-hidden rounded-xl border border-glass-border bg-glass/60 shadow-2xl shadow-neon/5 backdrop-blur-md">
        ...
        <div
          className={`mt-20 flex flex-col items-center gap-1 transition-opacity duration-500 ${
